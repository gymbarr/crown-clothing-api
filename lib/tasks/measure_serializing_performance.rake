...
task measure_serializing_performance: :environment do
  ...
  active_model_performance_one_object = Benchmark.measure do
    ActiveModelSerializers::ProductSerializer.new(product).serializable_hash.to_json
  end
  ...
  panko_performance_one_object = Benchmark.measure do
    PankoSerializers::ProductSerializer.new.serialize(product).symbolize_keys.to_json
  end
  ...
  active_model_performance_many_objects = Benchmark.measure do
    ActiveModelSerializers::SerializableResource.new(products,
                                                     each_serializer: ActiveModelSerializers::ProductSerializer).to_json
  end
